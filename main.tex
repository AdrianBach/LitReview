...
\section{Why should we conserve ?}
...
Luc: "Is that a satisfactory answer to your question? We conserve because we want to."
...
But most of them also despise aspect of the biodiversity that goes with it (insects, some plants), and would rather not have them around (negative utility).

We might also be preventing species from evolving by maintaining their environment in a relatively steady state. We slow the adaptation process.
...
Would it make sense in the way that general, overall biodiversity is not the goal of conservation, but biodiversity inside the different "functional" groups.
